...
<div>
    ...
    <div class="js-warn" id="js-warn-exit"><h1>JavaScript 已禁用</h1><p>此站点需要启用 JavaScript 功能。</p>
        <p>了解如何启用 JavaScript 请点击 <a href="https://www.enable-javascript.com/" rel="noopener" target="_blank">这里</a></p><label for="js-hide">关闭</label>
    </div>
</div>
<!-- /JS Warning -->
 </noscript>
...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg">Pi-<b>hole</b> 管理控制台</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>状态：</p>
                        ...
                        if ($pistatus == "1") {
                            echo '<a id="status"><i class="fa fa-circle text-green-light"></i> 活动</a>';
                        } elseif ($pistatus == "0") {
                            echo '<a id="status"><i class="fa fa-circle text-red"></i> 离线</a>';
                        } elseif ($pistatus == "-1") {
                            echo '<a id="status"><i class="fa fa-circle text-red"></i> DNS 服务未运行</a>';
                        } else {
                            echo '<a id="status"><i class="fa fa-circle text-orange"></i> 未知</a>';
                        }
                        ...
                        {
                            echo '<a id=\"temperature\"><i class="fa fa-circle text-red"></i> FTL 离线</a>';
                        }
                    ?>
                    <br/>
                    <?php
            ...
            <ul class="sidebar-menu">
                ...
                <li<?php if($scriptname === "queries.php"){ ?> class="active"<?php } ?>>
                    <a href="queries.php">
                        <i class="fa fa-file-alt"></i> <span>查询日志</span>
                    </a>
                </li>
                <li class="treeview<?php if($scriptname === "db_queries.php" || $scriptname === "db_lists.php" || $scriptname === "db_graph.php"){ ?> active<?php } ?>">
                  <a href="#">
                    ...
                    <i class="fa fa-clock"></i> <span>长期数据</span>
                  </a>
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "db_lists.php"){ ?> class="active"<?php } ?>>
                        <a href="db_lists.php">
                            <i class="fa fa-file-alt"></i> <span>活跃列表</span>
                        </a>
                    </li>
                  </ul>
                </li>
                ...
                <li<?php if($scriptname === "whitelist"){ ?> class="active"<?php } ?>>
                    <a href="groups-domains.php?type=white">
                        <i class="fa fa-check-circle "></i> <span>白名单</span>
                    </a>
                </li>
                <!-- Blacklist -->
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "groups-adlists.php"){ ?> class="active"<?php } ?>>
                        <a href="groups-adlists.php">
                            <i class="fa fa-shield-alt"></i> <span>广告列表</span>
                        </a>
                    </li>
                  </ul>
                </li>
                ...
                <li id="pihole-disable" class="treeview"<?php if ($pistatus == "0") { ?> hidden="true"<?php } ?>>
                  <a href="#">
                    ...
                    <i class="fa fa-stop"></i> <span>禁用&nbsp;&nbsp;&nbsp;<span id="flip-status-disable"></span></span>
                  </a>
                  <ul class="treeview-menu">
                    <li>
                        <a href="#" id="pihole-disable-permanently">
                            <i class="fa fa-stop"></i> <span>永久</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-10s">
                            <i class="fa fa-clock"></i> <span>10 秒</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-30s">
                            <i class="fa fa-clock"></i> <span>30 秒</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-5m">
                            <i class="fa fas fa-clock"></i> <span>5 分钟</span>
                        </a>
                    </li>
                    <li>
                      <a href="#" id="pihole-disable-cst" data-toggle="modal" data-target="#customDisableModal">
                            <i class="fa fa-clock"></i> <span>自定义时间</span>
                      </a>
                    </li>
                  </ul>
                ...
                <li id="pihole-enable" class="treeview"<?php if ($pistatus == "1") { ?> hidden="true"<?php } ?>>
                    <a href="#"><i class="fa fa-play"></i> <span id="enableLabel">启用&nbsp;&nbsp;&nbsp;<span id="flip-status-enable"></span></span></a>
                </li>
                <!-- Tools -->
                <li class="treeview <?php if(in_array($scriptname, array("gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php"))){ ?>active<?php } ?>">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "gravity.php"){ ?> class="active"<?php } ?>>
                        <a href="gravity.php">
                            <i class="fa fa-arrow-circle-down"></i> <span>更新规则</span>
                        </a>
                    </li>
                    <!-- Query Lists -->
                    <li<?php if($scriptname === "queryads.php"){ ?> class="active"<?php } ?>>
                        <a href="queryads.php">
                            <i class="fa fa-search"></i> <span>查询列表</span>
                        </a>
                    </li>
                    <!-- Audit log -->
                    <li<?php if($scriptname === "auditlog.php"){ ?> class="active"<?php } ?>>
                        <a href="auditlog.php">
                            <i class="fa fa-balance-scale"></i> <span>审核日志</span>
                        </a>
                    </li>
                    <!-- Tail pihole.log -->
                    <li<?php if($scriptname === "taillog.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog.php">
                            <i class="fa fa-list-ul"></i> <span>跟踪 pihole.log</span>
                        </a>
                    </li>
                    <!-- Tail pihole-FTL.log -->
                    <li<?php if($scriptname === "taillog-FTL.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog-FTL.php">
                            <i class="fa fa-list-ul"></i> <span>跟踪 pihole-FTL.log</span>
                        </a>
                    </li>
                    <!-- Generate debug log -->
                ...
                <li<?php if($scriptname === "network.php"){ ?> class="active"<?php } ?>>
                    <a href="network.php">
                        <i class="fa fa-network-wired"></i> <span>网络</span>
                    </a>
                </li>
                <!-- Settings -->
                ...
                <li<?php if($scriptname === "dns_records.php"){ ?> class="active"<?php } ?>>
                    <a href="dns_records.php">
                        <i class="fa fa-address-book"></i> <span>本地 DNS 记录</span>
                    </a>
                </li>
                <!-- Logout -->
                <?php
                ...
                <li>
                    <a href="?logout">
                        <i class="fa fa-user-times"></i> <span>注销</span>
                    </a>
                </li>
                <?php } ?>
                <?php } ?>
                ...
                <li<?php if($scriptname === "login"){ ?> class="active"<?php } ?>>
                    <a href="index.php?login">
                        <i class="fa far fa-user"></i> <span>登录</span>
                    </a>
                </li>
                <?php } ?>
                <!-- Donate -->
                <li>
                    <a href="https://pi-hole.net/donate/" rel="noopener" target="_blank">
                        <i class="fa-paypal-icon fab fa-paypal"></i> <span>捐赠</span>
                    </a>
                </li>
                <?php if($auth){ ?>
                <!-- Help -->
