...
<div class="row">
    <div class="col-lg-3 col-sm-6">
        ...
        <div class="small-box bg-green" id="total_queries" title="only A + AAAA queries">
            <div class="inner">
                <p>总查询 [ <span id="unique_clients">-</span> 个客户端 ]</p>
...
<div class="row">
    ...
    <div class="box" id="queries-over-time">
        <div class="box-header with-border">
          <h3 class="box-title">最近 <?php echo getinterval(); ?> 小时查询总数</h3>
        </div>
        <div class="box-body">
          <div class="chart">
...
<div class="row">
    ...
    <div class="box" id="clients">
        <div class="box-header with-border">
          <h3 class="box-title">最近 <?php echo getinterval(); ?> 小时客户端活动</h3>
        </div>
        <div class="box-body">
          <div class="chart">
...
<div class="row">
    ...
    <div class="<?php echo $tablelayout; ?>">
      <div class="box" id="client-frequency">
        <div class="box-header with-border">
          <h3 class="box-title">活跃客户端（总计）</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="table-responsive">
    ...
    <div class="<?php echo $tablelayout; ?>">
      <div class="box" id="client-frequency-blocked">
        <div class="box-header with-border">
          <h3 class="box-title">活跃客户端（仅阻止）</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="table-responsive">
